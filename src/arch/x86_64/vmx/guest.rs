...
pub(super) fn setup_guest_state(guest_rip: u64, guest_rsp: u64) {
    unsafe {
        ...
        vmwrite(VmcsField::GuestDsSelector as u64, 0);
        vmwrite(VmcsField::GuestDsLimit as u64, 0xFFFF);
        vmwrite(VmcsField::GuestDsArBytes as u64, 0x0093);
        vmwrite(VmcsField::GuestDsBase as u64, 0);
        vmwrite(VmcsField::GuestEsSelector as u64, 0);
        vmwrite(VmcsField::GuestEsLimit as u64, 0xFFFF);
        vmwrite(VmcsField::GuestEsArBytes as u64, 0x0093);
        vmwrite(VmcsField::GuestEsBase as u64, 0);
        vmwrite(VmcsField::GuestFsSelector as u64, 0);
        vmwrite(VmcsField::GuestFsLimit as u64, 0xFFFF);
        vmwrite(VmcsField::GuestFsArBytes as u64, 0x0093);
        vmwrite(VmcsField::GuestFsBase as u64, 0);
        vmwrite(VmcsField::GuestGsSelector as u64, 0);
        vmwrite(VmcsField::GuestGsLimit as u64, 0xFFFF);
        vmwrite(VmcsField::GuestGsArBytes as u64, 0x0093);
