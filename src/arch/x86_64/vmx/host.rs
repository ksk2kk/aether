...
pub(super) fn setup_host_state() {
    unsafe {
        ...
        vmwrite(
            VmcsField::HostIa32SysenterCs as u64,
            Msr::new(0x174).read(),
        );
        vmwrite(
            VmcsField::HostIa32SysenterEsp as u64,
            Msr::new(0x175).read(),
        );
        vmwrite(
            VmcsField::HostIa32SysenterEip as u64,
            Msr::new(0x176).read(),
        );
